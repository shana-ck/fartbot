...
import { type AtpAgent, type AtpSessionData, type ComAtprotoServerCreateSession, type ComAtprotoServerGetSession } from "@atproto/api";
...
export declare class Bot extends EventEmitter {
     ...
     */
    constructor({ service, langs, emitEvents, emitChatEvents, rateLimitOptions, cacheOptions, eventEmitterOptions, }?: BotOptions);
     ...
     */
    login({ identifier, password }: BotLoginOptions): Promise<ComAtprotoServerCreateSession.OutputSchema>;
    /**
     * Resume an existing session.
     * @param session Session data.
     * @returns Updated session data.
     */
    resumeSession(session: AtpSessionData): Promise<ComAtprotoServerGetSession.OutputSchema>;
    /**
     ...
     */
    label({ reference, labels, blobCids, comment }: BotLabelRecordOptions): Promise<void>;
    /**
     * Negate labels previously applied to a record by the bot.
     * @param options Information on the record to negate labels on.
     */
    negateLabels({ reference, labels, blobCids, comment }: BotLabelRecordOptions): Promise<void>;
     ...
     */
    createRecord(nsid: string, record: object, rkey?: string): Promise<StrongRef>;
    /**
