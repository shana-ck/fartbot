import { type AppBskyGraphDefs, type AppBskyRichtextFacet } from "@atproto/api";
...
export declare class List {
     ...
     */
    label(labels: Array<string>, comment?: string): Promise<void>;
    /**
     * Negate labels previously applied to the list.
     * @param labels The labels to negate.
     * @param comment An optional comment.
     */
    negateLabels(labels: Array<string>, comment?: string): Promise<void>;
    /**
