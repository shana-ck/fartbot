...
export declare class Profile {
     ...
     */
    labelAccount(labels: Array<string>, comment?: string): Promise<void>;
    /**
     ...
     */
    negateAccountLabels(labels: Array<string>, comment?: string): Promise<void>;
    /**
     ...
     * @param comment An optional comment to attach to the label.
     */
    labelProfile(labels: Array<string>, comment?: string): Promise<void>;
    /**
     * Negate labels previously applied to the user's profile.
     * @param labels The labels to negate.
     * @param comment An optional comment to attach.
     */
    negateProfileLabels(labels: Array<string>, comment?: string): Promise<void>;
    /**
     * Constructs an instance from a ProfileView.
     * @param view The ProfileView to construct from.
     * @param bot The active Bot instance.
     */
    static fromView(view: AppBskyActorDefs.ProfileView | AppBskyActorDefs.ProfileViewBasic, bot: Bot): Profile;
}
/**
