 ...
 */
export declare class ImagesEmbed extends PostEmbed {
    images: Array<EmbedImage>;
    /**
     * @param images The images within this embed.
     */
    constructor(images: Array<EmbedImage>);
     ...
     */
    static fromView(imagesView: AppBskyEmbedImages.View, imagesRecord: AppBskyEmbedImages.Main): ImagesEmbed;
}
